...
public class MensagemDAO extends AbstractDAO<MensagemBean, MensagemPk> {
    ...
    /** SQL para DELETE */
    private static final String SQL_DELETE = "DELETE FROM mensagem";
     ...
     * @throws DAOException
     */
    public MensagemBean insertAi(MensagemBean bean) throws DAOException {
        try {
